...
namespace BetfairNG
{
    ...
    {
        bool Login(string p12CertificateLocation, 
        ...
        Task<BetfairServerResponse<CurrentOrderSummaryReport>> ListCurrentOrders(
        ...
        Task<BetfairServerResponse<ClearedOrderSummaryReport>> ListClearedOrders(
            BetStatus betStatus,
        ...
        Task<BetfairServerResponse<List<MarketProfitAndLoss>>> ListMarketProfitAndLoss(
        ...
        Task<BetfairServerResponse<PlaceExecutionReport>> PlaceOrders(
            string marketId, 
        ...
        Task<BetfairServerResponse<ReplaceExecutionReport>> ReplaceOrders(
            string marketId,
            IList<ReplaceInstruction> instructions,
            string customerRef = null,
            MarketVersion marketVersion = null);

        Task<BetfairServerResponse<UpdateExecutionReport>> UpdateOrders(
            string marketId,
        ...
        Task<BetfairServerResponse<List<RaceDetails>>> ListRaceDetails(
